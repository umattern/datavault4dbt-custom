{%- macro fabric__pit(tracked_entity, hashkey, sat_names, ldts, ledts, sdts, snapshot_relation, dimension_key, refer_to_ghost_records, additional_columns, snapshot_trigger_column=none, custom_rsrc=none, pit_type=none) -%}
