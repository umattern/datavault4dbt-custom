{%- macro databricks__ref_table(ref_hub, ref_satellites, src_ldts, src_rsrc, historized, additional_columns, snapshot_trigger_column='is_active', snapshot_relation=none) -%}
